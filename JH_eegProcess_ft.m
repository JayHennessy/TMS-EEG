...
prompt = 'Please enter an array containing the indices of the epochs that you would like to discard \n \n';
...
prompt = ['At what cut-off time would you like your TMS ringing cut? \n '...
...
prompt = 'Is the cut-off at an acceptable latency? \n \n ';
